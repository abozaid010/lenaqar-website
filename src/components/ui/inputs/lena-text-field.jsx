    ...
    >
      ...
      <div className="relative">
        ...
        <input
          ...
          required={required}
          disabled={disabled}
          className={`block w-full min-h-[40px] rounded-md border py-2.5 px-3 focus:outline-none focus:ring-2 bg-white text-gray-900 appearance-none transition-all duration-200 ${

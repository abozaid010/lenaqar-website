    ...
    >
      <div className="flex items-center gap-2 px-3 py-2">
        ...
        <button
          type="button"
          onClick={startSave}
          className="inline-flex h-10 min-h-10 shrink-0 items-center gap-1 rounded-md border border-primary/20 bg-white px-2.5 text-xs font-medium text-primary hover:bg-primary/5 transition-colors"
          title={translate(
        ...
        <div className="border-t border-[#E6E6E6] bg-white px-3 py-2 space-y-2">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="h-11 min-h-11 min-w-0 flex-1 rounded-md border border-[#E6E6E6] px-2 text-base text-[#494A4B] focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
              autoFocus
              maxLength={60}
            />
            <button
              type="button"
              onClick={handleSave}
              className="inline-flex h-11 w-11 min-h-11 min-w-11 items-center justify-center rounded-md bg-primary text-white hover:bg-primary/90 transition-colors"
            ...
            <button
              ...
              className="inline-flex h-11 w-11 min-h-11 min-w-11 items-center justify-center rounded-md border border-[#E6E6E6] bg-white text-gray-600 hover:bg-gray-50 transition-colors"
                    ...
                    {isEditing ? (
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="h-11 min-h-11 min-w-0 flex-1 rounded-md border border-[#E6E6E6] px-2 text-base focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                          autoFocus
                          maxLength={60}
                        />
                        <button
                          ...
                          className="inline-flex h-10 w-10 min-h-10 min-w-10 items-center justify-center rounded-md bg-primary text-white hover:bg-primary/90"
                        ...
                        <button
                          ...
                          className="inline-flex h-10 w-10 min-h-10 min-w-10 items-center justify-center rounded-md border border-[#E6E6E6] text-gray-600 hover:bg-gray-50"
                          aria-label={translate("buttons.cancel", "Cancel")}
                        >
                          <X size={14} />
                        </button>
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          <button
                            ...
                            className="h-10 min-h-10 rounded-md bg-red-600 px-3 text-xs font-medium text-white hover:bg-red-700"
                          >
                          ...
                          <button
                            ...
                            className="h-10 min-h-10 rounded-md border border-[#E6E6E6] px-3 text-xs font-medium text-gray-600 hover:bg-gray-50"
                          >
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex shrink-0 items-center gap-0.5">
                          <button
                            ...
                            className="inline-flex h-10 w-10 min-h-10 min-w-10 items-center justify-center rounded-md text-gray-500 hover:bg-gray-100 hover:text-gray-700"
                            aria-label={translate(
                              "unitsFilter.favoriteSearches.rename",
                              "Rename"
                            )}
                          ...
                          <button
                            ...
                            className="inline-flex h-10 w-10 min-h-10 min-w-10 items-center justify-center rounded-md text-gray-500 hover:bg-red-50 hover:text-red-600"

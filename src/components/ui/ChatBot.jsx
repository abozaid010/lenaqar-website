...
const ChatBot = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-4 right-4 w-90 h-[620px] bg-white rounded-lg shadow-2xl z-50 transition-all duration-300 transform ${isChatOpen ? "scale-100 opacity-100" : "scale-95 opacity-0 pointer-events-none"} flex flex-col`}
      >

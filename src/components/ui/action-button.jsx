...
const ActionButton = React.forwardRef(function ActionButton(
  ...
  return (
    ...
    >
      {ResolvedIcon ? (
        <ResolvedIcon className={sizeConfig.icon} strokeWidth={1.75} aria-hidden />
      ) : null}
      {hasLabel ? (
 ...
 */
export const EditButton = React.forwardRef(function EditButton(props, ref) {
  return <ActionButton ref={ref} type="edit" {...props} />;
});

export const DeleteButton = React.forwardRef(function DeleteButton(props, ref) {

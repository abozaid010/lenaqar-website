    ...
    return (
      <div className="flex items-center gap-2">
        <input
          ...
          onBlur={saveName}
          disabled={isSaving}
          className="text-base lg:text-sm font-bold text-primary border-b-2 border-primary bg-transparent focus:outline-none w-40 min-h-10 lg:min-h-0 px-1"
  ...
  return (
    <div className="flex items-center gap-1.5 group/name min-w-0">
      ...
      <button
        ...
        className="shrink-0 opacity-100 sm:opacity-0 sm:group-hover/name:opacity-100 min-h-9 min-w-9 lg:min-h-0 lg:min-w-0 inline-flex items-center justify-center p-1.5 lg:p-0.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded transition-all"

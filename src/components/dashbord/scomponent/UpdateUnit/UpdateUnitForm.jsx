  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (formData.purpose === "Rent") {
        ...
        //   toast.error(
        //     "Please provide an availability date for rental properties"
        //   );
        //   setIsUpdating(false);
        //   return;
        // }
        ...
        // if (!hasValidPrice) {
        //   toast.error(
        //     "Please provide at least one price for rental duration options"
        //   );
        //   setIsUpdating(false);
        //   return;
        // }
      ...
      if (
        ...
        preparedFormData.deliveryStatus =
          deliveryDate > today ? "off-plan" : "ready to move";
      }
      ...
      if (formData.purpose === "Rent") {
        ...
        preparedFormData.amenities = formData.amenities;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              >
                ...
                {propertyEnums.EnumPropertyIntent.filter(
                  (intent) =>

...
const SidebarComponent = ({
  ...
  const visibleClientId = currentClientId;
      ...
      >
        ...
        <div className="border-t border-gray-200 p-3 space-y-2 shrink-0">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2 px-2 bg-[#25D366] hover:bg-[#20BA5A] text-white text-xs font-medium rounded-md shadow-sm transition-colors"
          >
            <svg
              width="16"
              height="16"
            ...
            <span className="truncate">{translate("header.sendMessage")}</span>
          </button>
          ...
          <div className="pt-1 border-t border-gray-100 space-y-1">
            <div className="flex items-center gap-2 px-1 py-1">
              <div className="h-7 w-7 shrink-0 bg-blue-100 rounded-full flex items-center justify-center">
            ...
            {visibleClientId ? (
              <Link
                ...
                className="flex items-center gap-2 w-full text-xs font-medium text-gray-700 hover:bg-gray-100 py-1.5 px-2 rounded-md transition-colors"
              >
                <Settings className="h-4 w-4 shrink-0" />
                <span className="truncate">{translate("header.userMenu.settings")}</span>
              </Link>
            ) : (
              <button
                type="button"
                onClick={() => toast.error(translate("header.settingsLoginRequired"))}
                className="flex items-center gap-2 w-full text-xs font-medium text-gray-700 hover:bg-gray-100 py-1.5 px-2 rounded-md transition-colors text-start"
              >
                <Settings className="h-4 w-4 shrink-0" />
                <span className="truncate">{translate("header.userMenu.settings")}</span>
              </button>
            ...
            <button
              ...
              className="flex items-center gap-2 w-full text-xs font-medium text-red-600 hover:bg-red-50 py-1.5 px-2 rounded-md transition-colors text-start"
            >
              <LogOut className="h-4 w-4 shrink-0" />
              <span className="truncate">{translate("header.userMenu.logout")}</span>
            </button>
          </div>
        </div>
      </div>

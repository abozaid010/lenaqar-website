      ...
      <div className="container">
        <FadeIn className="flex flex-col sm:flex-row justify-center gap-4 max-w-lg mx-auto">
          ...
          >
            ...
            {translate("solutions.agencies.landing.finalCta.downloadApp")}
          </Link>
          <a
            href={getWhatsAppUrl(translate("solutions.agencies.partnerMessage"))}
            target="_blank"
          ...
          >
            ...
            {translate("solutions.agencies.landing.finalCta.contactUs")}
          </a>
        </FadeIn>
      </div>
    </section>

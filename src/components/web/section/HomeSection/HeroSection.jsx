            ...
            >
              ...
              >
                ...
                >
                  ...
                  24/7, and boost conversions so you focus on closing, not
                  chasing cold leads.
                </motion.p>
...
const AiMessageBubble = ({ message, position }) => {
  ...
  const getEntryAnimation = () => {
    switch (position) {
      case 0:
        return { y: -20, opacity: 0, rotate: -3 }; // Added rotation
      case 1:
        return { y: 20, opacity: 0, rotate: 2 }; // Added rotation
      case 2:
        return { x: 20, opacity: 0, rotate: 3 }; // Added rotation
      case 3:
        return { x: -20, opacity: 0, rotate: -2 }; // Added rotation
      default:
  ...
  const getConnectorStyle = () => {
    switch (posStyle.arrow) {
      case "bottom":
        return {
          className:
            "absolute top-full left-1/2 h-10 w-[2px] bg-gradient-to-b from-white to-transparent",
      ...
      case "top":
        return {
          className:
            "absolute bottom-full left-1/2 h-10 w-[2px] bg-gradient-to-t from-white to-transparent",
      ...
      case "left":
        return {
          className:
            "absolute right-full top-1/2 w-10 h-[2px] bg-gradient-to-l from-white to-transparent",
      ...
      case "right":
        return {
          className:
            "absolute left-full top-1/2 w-10 h-[2px] bg-gradient-to-r from-white to-transparent",
  ...
  return (
    <motion.div
      ...
      animate={{
        ...
        opacity: 1,
        rotate:
          position === 2 ? 1.5 : position === 3 ? -2 : position === 0 ? -2 : 1,
      }} // Added specific rotations
    ...
    >
      <div
        className={`px-4 py-3 rounded-lg shadow-lg font-medium text-sm md:text-base relative max-w-[240px] md:max-w-xs ${bubbleStyle}`}
      >
        {message}
        {/* Arrow pointing to the AI */}
        <div
          className={`${arrowStyle} ${bubbleStyle.includes("gradient") ? "bg-blue-500" : bubbleStyle.split(" ")[0]}`}
        />
      </div>

...
function TypeGallery({ label, urls }: { label: string; urls: string[] }) {
  ...
  return (
    <div>
      <p className="text-sm font-medium text-gray-700 mb-2 capitalize">{label.replace(/_/g, ' ')}</p>
...
export default function ProjectBuildingTypeGallery({ project }: Props) {
  ...
  return (
    <div className="bg-white rounded-lg border p-6">
      <h2 className="text-xl font-semibold text-gray-900 mb-4">Unit Type Galleries</h2>

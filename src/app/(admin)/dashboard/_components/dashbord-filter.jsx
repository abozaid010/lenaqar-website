      ...
      <div className="flex flex-col gap-2 flex-1 min-w-0 w-full">
        ...
        <div className="flex items-center justify-end gap-2 w-full flex-wrap lg:hidden">
          ...
          >
            ...
            <span>
              {translate("dashboardFilter.importLeads.button")}
            </span>
          </button>
          {showExportButton && (
          ...
          {showWhatsappToolbarButton && (
            <button
              ...
              className={`flex items-center gap-2 px-3 bg-white border border-gray-300 text-gray-800 rounded-md hover:bg-gray-50 transition-colors text-sm font-medium shadow-sm ${compact ? "h-9 min-h-[36px]" : "h-10"}`}
      ...
      <div className="hidden lg:flex items-center gap-2 shrink-0">
        ...
        {showWhatsappToolbarButton && (
          <button
            type="button"
            onClick={handleOpenWhatsappBulk}
            className={`flex items-center gap-2 px-4 bg-white border border-gray-300 text-gray-800 rounded-md hover:bg-gray-50 transition-colors text-sm font-medium shadow-sm hover:shadow-md ${compact ? "h-9" : "h-10"}`}
            title={translate("dashboardFilter.bulkWhatsapp.sendButton")}
          >
            <svg
              className="w-[18px] h-[18px] text-green-600 shrink-0"
              viewBox="0 0 24 24"
              fill="currentColor"
              aria-hidden
            >

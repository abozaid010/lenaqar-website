    ...
    <div className="relative flex-1 min-h-0 min-w-0 w-full flex flex-col gap-1 overflow-x-hidden">
      <div className="no-print flex flex-wrap lg:flex-nowrap items-center gap-2 shrink-0 min-w-0 min-h-10 lg:min-h-9">
        <button
          ...
          className="inline-flex items-center justify-center gap-1.5 h-10 min-h-10 min-w-10 lg:h-9 lg:min-h-9 px-2.5 sm:px-3 rounded-md bg-primary text-sm font-medium text-white shadow-sm hover:bg-primary/90 active:scale-[0.98] transition-all shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
        >
      ...
      >
        <div className="flex items-center justify-between gap-2 border-b border-gray-100 px-3 py-2.5 shrink-0">
          ...
          <button
            type="button"
            onClick={() => setIsFiltersOpen(false)}
            className="inline-flex items-center justify-center min-h-10 min-w-10 lg:min-h-8 lg:min-w-8 rounded-md text-gray-500 hover:bg-gray-100 hover:text-gray-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
            aria-label={filterPanelCloseLabel}
          >

"use client";
import { ArrowLeft, Search, User, Heart } from "lucide-react";
...
export default function Header() {
  ...
  return (
    <header 
      ...
      style={{ 
        background: "linear-gradient(135deg, rgba(3,2,80) 0%, rgba(30,30,122) 100%)",
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <div className="text-center transform -translate-y-0.5">
            <h1 className="text-white text-xl md:text-2xl font-bold relative inline-block">
              <span className="relative z-10 tracking-wide">Real Estate Properties</span>
            ...
            <p className="text-blue-100 text-xs sm:text-sm font-light mt-0.5">
              <span className="hidden sm:inline">✦</span> Explore our exclusive listings <span className="hidden sm:inline">✦</span>
            </p>
          </div>

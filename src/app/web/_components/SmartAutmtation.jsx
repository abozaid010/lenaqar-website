            ...
            <ul className="space-y-6 mb-8">
              <li className="flex items-start">
                ...
                <p className="text-gray-700 text-lg">
                  "I waste hours talking to unqualified leads who aren't serious
                  buyers."
                </p>
              </li>
              ...
              <li className="flex items-start">
                ...
                <p className="text-gray-700 text-lg">
                  "I need a faster way to follow up—before my leads buy
                  somewhere else."
                </p>
              </li>
              ...
              <li className="flex items-start">
                ...
                <p className="text-gray-700 text-lg">
                  "Our CRM is full of junk leads, making it hard to track real
                  opportunities."
                </p>
              </li>
            </ul>

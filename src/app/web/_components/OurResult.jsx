...
const OurResult = () => {
    ...
    const results = [
        { value: t.ourResultsInNumbers.fasterLeadResponseValue, label: t.ourResultsInNumbers.fasterLeadResponse },
        { value: t.ourResultsInNumbers.moreConversionValue, label: t.ourResultsInNumbers.moreConversion },
        { value: t.ourResultsInNumbers.engagementValue, label: t.ourResultsInNumbers.engagement },
        { value: t.ourResultsInNumbers.lessManualWorkValue, label: t.ourResultsInNumbers.lessManualWork },
        { value: t.ourResultsInNumbers.increaseInSalesValue, label: t.ourResultsInNumbers.increaseInSales },
        { value: t.ourResultsInNumbers.increaseInCSATValue, label: t.ourResultsInNumbers.increaseInCSAT },
    ];
    return (

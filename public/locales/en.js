export default {
  ...
  footer: {
    "companyInfo": {
      ...
      "address": "Company Address: 505 Siac Building, ARCHPLAN Square, New Capital, Cairo, Egypt"
    },
    "contact": {
  ...
  toasts: {
    ...
    imageRemoveFailed: "Failed to remove image from the server. Please try again.",

...
export default {
  ...
  socialMedia: {
    ...
    activation: {
      ...
      batchHint:
        "هذه الجولة تعالج حتى {limit} منشورًا وقد تستغرق بضع دقائق. يمكنك الإيقاف المؤقت في أي وقت.",
      pauseRequested: "تم طلب الإيقاف. سينتهي المنشور الحالي أولًا.",
      resumeSuccess: "تم استئناف التفعيل. يمكنك بدء دفعة جديدة.",
      stillRunning:
        "الذكاء الاصطناعي ما زال يعمل في الخلفية. سيستمر تحديث التقدم.",
      stoppedEarly:
        "توقفت الدفعة مبكرًا: تمت معالجة {processed} ({sent} تم الإرسال، {skipped} تم التخطي، {failed} فشل).",
      ...
      pausedBody:
        "الدفعات اليدوية والتفعيل التلقائي عبر الويب هوك معلّقة حتى يقوم أحد بالاستئناف.",
    },
    empty: {

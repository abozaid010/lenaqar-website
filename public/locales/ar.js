...
export default {
  ...
  actionCatalog: {
    selectPlaceholder: "اختر إجراءً",
    labels: {
      NEW: "جديد",
      MAKE_A_CALL: "إجراء مكالمة",
      OFFICE_VISIT: "زيارة مكتب",
      PROPERTY_VIEW: "معاينه",
      QUALIFIED_LEAD: "موجه للشراء",
      NOT_INTERESTED: "غير مهتم",
      INTERESTED: "مهتم",
      NOT_QUALIFIED: "غير مؤهل",
      DID_NOT_REPLY: "لم يرد",
      FOLLOW_UP_LATER: "متابعة لاحقاً",
      MISSING_REQUIREMENT: "طلب مفتوح",
      BLOCKED: "محظور",
      PURCHASED_THROUGH_US: "تم الشراء من خلالنا",
      LISTED_WITH_US: "مدرج لدينا",
      PROPERTY_ALREADY_SOLD: "العقار مباع بالفعل",
      COLLABORATION_ACCEPTED: "تم قبول التعاون",
      COLLABORATION_REJECTED: "تم رفض التعاون",
      DEAL_CLOSED: "تم إغلاق الصفقة",
      NO_ANSWER: "لا يوجد رد",
      WRONG_NUMBER: "رقم خاطئ",
      CALLBACK_REQUESTED: "طلب إعادة الاتصال",
      MEETING_DONE: "تمت المقابلة",
      RESCHEDULED: "تم إعادة الجدولة",
      UNDER_NEGOTIATION: "قيد التفاوض",
      OFFER_SENT: "تم إرسال العرض",
      CONTRACT_SIGNED: "تم توقيع العقد",
      LOST_TO_COMPETITOR: "خسر لصالح منافس",
      LOW_BUDGET: "ميزانية منخفضة",
      LOCATION_MISMATCH: "عدم تطابق الموقع",
    },
    errors: {
      catalogUnavailable:
        "كتالوج الإجراءات غير متاح. حاول تحديث الصفحة.",
      actionRequired: "يرجى اختيار إجراء",
      unknownAction: "إجراء غير معروف",
      filterOnlyNotSubmittable: "يمكن استخدام هذا الإجراء كفلتر فقط",
      meetingTimeRequired: "وقت الموعد مطلوب لهذا الإجراء",
    },
    terminalConfirm: {
      title: "تأكيد إجراء نهائي",
      message: "سيؤدي هذا الإجراء إلى إيقاف المتابعة مع العميل. هل تريد المتابعة؟",
      confirm: "متابعة",
    },
  },

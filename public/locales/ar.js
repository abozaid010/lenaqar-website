export default {
  ...
  dashboard: {
    ...
    "subtitle": "متاحة على الويب الموبايل - الوصول في أي وقت ومن أي مكان",
    "featuresTitle": "مع تكامل لينا السلس بين الويب والجوال، يمكنك:",
    "features": {
      "feature1": " تطبيق دردشة موبايل : خلى العملاء بتوعك يتواصلو معاك ف اى وقت عن طريق الشات اب",
      "feature2": "تطبيق موبايل للبروكرز – يبلغ فريق المبيعات فورًا أول ما يتحدد معاينة العقار ,تقدر تتابع محادثات وتفاعل لينا مع عملائك لحظة بلحظة.",
      "feature3": " متابعة تلقائية بالذكاء الاصطناعي – السيستم بيتابع مع العملاء أوتوماتيك ويوفر وقت فريقك.",
      "feature4": "شات بوت على موقعك – بيرد على استفسارات الزوار ٢٤ ساعة",
      "feature5": " ذكي – نظام متكامل لإدارة المبيعات، الوحدات، والعملاء بسهولة.",
      "feature6": " تحليلات عن العملاء – شوف احتياجات كل عميل وسجل تواصله علشان تركّز على الفرص الصح وتقفل الصفقات أسرع."
    },
    "ctaButton": "ابدأ الآن",
    "images": {
  ...
  salesManager: {
    ...
    "challenges": {
      ...
      "challenge2": "بيقضى ربع اليوم بس محاولات المتابعة مع العملاء قبل ما يشتروا من غيره",
      "challenge3": "عندنا CRM بس مش بنستخدمه عشان صعب او ملوش علاقه بالواقع وكمان الدعم مش موجود"
    },
  ...
  dataInsights: {
    ...
    "challenges": {
      ...
      "challenge2": "فريق المبيعات يلومني على 'العملاء منخفضي الجودة'، لكنني لا أملك الأدوات المناسبة لمعرفة الجادين منهم",
  ...
  unitDetails: {
    ...
    "viewTypes": {
      ...
      "lake": "إطلالة على البحيرة",
      "golf": "إطلالة على ملعب الجولف",
      "landmark": "إطلالة على معلم سياحي",
      "partial": "إطلالة جزئية",
      "open": "إطلالة مفتوحة",
      "desert": "إطلالة على الصحراء",
      "river": "إطلالة على النهر",
      "courtyard": "إطلالة على الفناء",
      "forest": "إطلالة على الغابة",
      "beach": "إطلالة على الشاطئ",
      "lagoon": "إطلالة على البحيرة",
      "openArea": "إطلالة على منطقة مفتوحة"
    },
    "finishingTypes": {
